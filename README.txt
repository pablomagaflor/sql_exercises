...
The data base for the challenges 1-5 can be found here:
...
The data base for challenge 6 can be found here:
    * https://drive.google.com/file/d/1wDqIK6zt5twWnCOx97ywipaiWR2d0OfT/view
    * The database is called "gym" and contain 3 tables related to the bookings, facilities, and membership of the gym
    * I used the cd schema for these challenge problems
